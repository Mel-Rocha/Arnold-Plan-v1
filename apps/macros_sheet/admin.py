...
class MacrosSheetAdmin(admin.ModelAdmin):
    list_display = ('macros_planner', 'week', 'kcal', 'cho', 'ptn', 'fat', 'kcal_level', 'cho_proportion', 'ptn_proportion', 'fat_proportion')
    ...
    fieldsets = (
        ...
        ('Macros', {'fields': ('cho', 'ptn', 'fat', 'kcal', 'kcal_level', 'cho_proportion', 'ptn_proportion', 'fat_proportion')}),
    )

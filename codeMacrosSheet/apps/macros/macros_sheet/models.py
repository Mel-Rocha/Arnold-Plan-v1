...
from apps.macros.kcal.enums import KcalLevel
from apps.macros.kcal.enums import calculate_kcal, calculate_kcal_level
from apps.macros.cho.enums import ChoLevel 
from apps.macros.cho.enums import calculate_cho_level
from apps.macros.ptn.enums import PtnLevel
from apps.macros.ptn.enums import calculate_ptn_level
from apps.macros.fat.enums import FatLevel
from apps.macros.fat.enums import calculate_fat_level
from apps.macros.macros_planner.models import MacrosPlanner
from apps.macros.proportion_gkg.calcs import ProportionGKG

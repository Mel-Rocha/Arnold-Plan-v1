...
urlpatterns = [
    ...
    path('food_options_list/<int:pk>/', views.food_options_list, name='food_options_list'),    path('food_options/<int:pk>/update/', views.food_options_update, name='food_options_update'),
